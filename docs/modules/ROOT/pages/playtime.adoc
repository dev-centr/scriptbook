...
* link:playbook-profile.adoc[Playbook profile] â€” directives
* link:host-awareness.adoc[Host Awareness] â€” how PlayTime learns the OS
* link:sidecar.adoc[Sidecar schema] â€” run records
