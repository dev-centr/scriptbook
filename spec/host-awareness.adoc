...
[.themed-svg]
image::images/playtime-bootstrap.svg[alt="Deadlock cycle crossed out; snapshot then Equivalence Engine bind"]
...
[.themed-svg]
image::images/playtime-growth-ratchet.svg[alt="Rules to CI bake to shipped PlayTime to more playbooks back to new catalog rows"]
...
[.themed-svg]
image::images/playtime-attic-basement.svg[alt="House: intents in the attic, PlayTime stairs, catalog in the basement"]

Overlays (`wsl`, `cygwin`, `container`) are stickers on a family, not new planets.

.Overlays are stickers
[.themed-svg]
image::images/playtime-overlays.svg[alt="Family circles with wsl, cygwin, container stickers"]
