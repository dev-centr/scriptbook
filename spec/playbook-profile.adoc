...
.Columns, not a cube
[.themed-svg]
image::images/playtime-facets-not-lattice.svg[alt="Catalog table of os, format, runtime versus a forbidden path-segment lattice"]

.The student asked: MSI or bash?
[.themed-svg]
image::images/playtime-two-doors.svg[alt="Two doors labeled MSI and bash; that is not a questionnaire"]
